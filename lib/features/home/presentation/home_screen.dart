...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.security_rounded, color: Colors.white70),
            onPressed: () {},
          ),
        ],
      ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.create_new_folder_rounded, color: Colors.white, size: 28),
      ),
    );
  }
  ...
  Widget _buildFoldersGrid(HomeProvider homeProvider, List<HomeCategory> folders) {
    return Expanded(
      child: folders.isEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return CategoryCard(
            ...
            onEdit: isCustomFolder ? () => _showEditFolderDialog(context, category) : null,
            onDelete: isCustomFolder ? () => _showDeleteDialog(context, category, homeProvider) : null,
          );
        },
      ),
    );
  ...
  void _showDeleteDialog(BuildContext context, HomeCategory folder, HomeProvider homeProvider) {
    showDialog(
      context: context,
